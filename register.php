    ...
    <main class="form-signin w-100 m-auto">
        <form action="register_db.php" method="post">
            ...
            <div class="form-floating">
                <input type="text" class="form-control my-3" name="username" id="floatingInput" placeholder="name@example.com">
            ...
            <p class="mt-5 mb-3 text-body-secondary">Have already an account? <a href="login.php">Signin</a></p>
        </form>
    </main>
    <div class="container">
        <!-- Footer Start -->
